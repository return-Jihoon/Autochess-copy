...
//statCBData.z = 1.0f;
	...
	{
		starSprite = GetActor()->AddComponent<SpriteRender>(RG_PLAYER);
	...
	hpSprite = GetActor()->AddComponent<SpriteRender>(RG_PLAYER);
	...
	mpSprite = GetActor()->AddComponent<SpriteRender>(RG_PLAYER);
	...
	coolSprite = GetActor()->AddComponent<SpriteRender>(RG_PLAYER);
