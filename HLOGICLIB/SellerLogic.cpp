...
void SellerLogic::Init(Scene* _Scene)
{
	...
	for (size_t i = 0; i < 5; i++)
	{
		...
		sellerActorArr[i].spritePtr = sellerActorArr[i].actor->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
...
#pragma region NONE
	...
	sellerActorArr[5].spritePtr = sellerActorArr[5].actor->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
