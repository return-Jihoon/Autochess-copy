...
void CollectSceneUpdater::Loading()
{
	...
	Font = Resources::Find<EngineFont>(L"1훈떡볶이");
...

	{
		...
		HPTR<SpriteRender> SR = BPlate->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

	{
		...
		HPTR<SpriteRender> SR = StandFrameUpper->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

	{
		...
		HPTR<SpriteRender> SR = StandSprite->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

	{
		...
		HPTR<SpriteRender> SR = StandFrameLower->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
		SR->SetSprite(L"Level.png", 0);
...

	{
		...
		HPTR<SpriteRender> SR = LButton->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

	{
		...
		HPTR<SpriteRender> SR = RButton->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
	...
	
	{
		...
		HPTR<SpriteRender> SR = SCBar->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
	...
	for (int i = 0; i < 63; ++i)
	{
		...
		HPTR<SpriteRender> SR = StandEx[i]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

		{
			...
			HPTR<SpriteRender> SR = StandNamePlateClass[i]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

			{
				...
				HPTR<SpriteRender> SR = StandNameClass[i]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
		...
		}
		{
			...
			HPTR<SpriteRender> SR = StandNamePlateRace[i]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

			{
				...
				HPTR<SpriteRender> SR = StandNameRace[i]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
			...
			if (Pieces[i].RACE2 != 0)
			{
				...
				HPTR<SpriteRender> SR = StandNamePlateRace2[i]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

				{
					...
					HPTR<SpriteRender> SR = StandNameRace2[i]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
		...
		}
		{
			...
			HPTR<SpriteRender> SR = StandNamePlate[i]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

			{
				...
				HPTR<SpriteRender> SR = StandName[i]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
	...
	for (int i = 0; i < 13; ++i)
	{
		...
		HPTR<SpriteRender> SR = ClassEx[i]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
	...
	for (int i = 0; i < 15; ++i)
	{
		...
		HPTR<SpriteRender> SR = RaceEx[i]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
	...
	for (int i = 0; i < 6; ++i)
	{
		...
		HPTR<SpriteRender> SR = StarEx[i]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
	...
	{
		{
			...
			HPTR<SpriteRender> SR = MenuLetter[0]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

		{
			...
			HPTR<SpriteRender> SR = MenuLetter[1]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

		{
			...
			HPTR<SpriteRender> SR = MenuLetter[2]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

	{
		...
		HPTR<SpriteRender> SR = Face->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
	...
	}
	{
		...
		HPTR<SpriteRender> SR = FaceComp[0]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

	{
		...
		HPTR<SpriteRender> SR = FaceComp[1]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

	{
		...
		HPTR<SpriteRender> SR = FaceComp[2]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
	...
	}
	{
		...
		HPTR<SpriteRender> SR = FaceComp[3]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
	...
	}
	{
		...
		HPTR<SpriteRender> SR = FaceComp[4]->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

	{
		...
		HPTR<SpriteRender> SR = ESCButton->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
	...
	
	{
		...
		HPTR<SpriteRender> SR = Metamorphosis->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

	{
		...
		HPTR<SpriteRender> SR = GetOutButton->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...

	{
		...
		HPTR<SpriteRender> SR = BPlate2->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...
#pragma region Value
	ClassEx[0]->GetComponent<SpriteRender>()->SetSprite(L"Class.png", CurClass);
	RaceEx[0]->GetComponent<SpriteRender>()->SetSprite(L"Race.png", CurRace);
	StarEx[0]->GetComponent<SpriteRender>()->SetSprite(L"Stars.png", CurLevel);

	if(CurClass != 0)
		MenuLetter[0]->GetComponent<SpriteRender>()->SetSprite(L"LetterData.png", CurClass * 3 + 1);
	else
		MenuLetter[0]->GetComponent<SpriteRender>()->SetSprite(L"LetterData.png", 182);

	if (CurRace != 0)
		MenuLetter[1]->GetComponent<SpriteRender>()->SetSprite(L"LetterData.png", CurRace * 3 + 2);
	else
		MenuLetter[1]->GetComponent<SpriteRender>()->SetSprite(L"LetterData.png", 185);
	...
	if (SelectON == true && CurStand != -1)
	{
		if (TransOn == false)
		{
			...
			StandSprite->GetComponent<SpriteRender>()->SetSprite(Pieces[CurStand].Anim[CurStar].c_str());
			StandSprite->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", Pieces[CurStand].Anim[CurStar].c_str());
			Metamorphosis->GetComponent<SpriteRender>()->SetSprite(L"Metamorphosis.png", 0);
		}
		else if (TransOn == true)
		{
			...
			case 25:
				if (CurStar == 0)
				{
					...
					StandSprite->GetComponent<SpriteRender>()->SetSprite(L"Stand26_1a.png");
					StandSprite->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", L"Stand26_1a.png");
				}
				else if (CurStar == 1)
				{
					StandSprite->GetComponent<SpriteAnimaion>()->ChanageAni(L"Stand26_2a.png");
					StandSprite->GetComponent<SpriteRender>()->SetSprite(L"Stand26_2a.png");
					StandSprite->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", L"Stand26_2a.png");
				}
				else
				{
					StandSprite->GetComponent<SpriteAnimaion>()->ChanageAni(L"Stand26_3a.png");
					StandSprite->GetComponent<SpriteRender>()->SetSprite(L"Stand26_3a.png");
					StandSprite->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", L"Stand26_3a.png");
				}
				break;
			case 38:
				if (CurStar == 0)
				{
					...
					StandSprite->GetComponent<SpriteRender>()->SetSprite(L"Stand39_1a.png");
					StandSprite->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", L"Stand39_1a.png");
				}
				else if (CurStar == 1)
				{
					StandSprite->GetComponent<SpriteAnimaion>()->ChanageAni(L"Stand39_2a.png");
					StandSprite->GetComponent<SpriteRender>()->SetSprite(L"Stand39_2a.png");
					StandSprite->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", L"Stand39_2a.png");
				}
				else
				{
					StandSprite->GetComponent<SpriteAnimaion>()->ChanageAni(L"Stand39_3a.png");
					StandSprite->GetComponent<SpriteRender>()->SetSprite(L"Stand39_3a.png");
					StandSprite->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", L"Stand39_3a.png");
				}
				break;
			case 48:
				if (CurStar == 0)
				{
					...
					StandSprite->GetComponent<SpriteRender>()->SetSprite(L"Stand49_1a.png");
					StandSprite->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", L"Stand49_1a.png");
				}
				else if (CurStar == 1)
				{
					StandSprite->GetComponent<SpriteAnimaion>()->ChanageAni(L"Stand49_2a.png");
					StandSprite->GetComponent<SpriteRender>()->SetSprite(L"Stand49_2a.png");
					StandSprite->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", L"Stand49_2a.png");
				}
				else
				{
					StandSprite->GetComponent<SpriteAnimaion>()->ChanageAni(L"Stand49_3a.png");
					StandSprite->GetComponent<SpriteRender>()->SetSprite(L"Stand49_3a.png");
					StandSprite->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", L"Stand49_3a.png");
				}
				break;
			default:
				break;
			...
			Metamorphosis->GetComponent<SpriteRender>()->SetSprite(L"Metamorphosis.png", 1);
		}
		StandFrameUpper->GetComponent<SpriteRender>()->SetSprite(L"Level.png", CurStar);
		StandFrameLower->GetComponent<SpriteRender>()->SetSprite(L"Level.png", CurStar + 4);

		if (CurStar == 2)
		{
			StandFrameUpper->GetComponent<SpriteRender>()->SetSprite(L"Level.png", 3);
			StandFrameLower->GetComponent<SpriteRender>()->SetSprite(L"Level.png", 7);
		}

		Face->GetComponent<SpriteRender>()->SetSprite(L"Face.png", CurStand);

		FaceComp[0]->GetComponent<SpriteRender>()->SetSprite(L"Class.png", Pieces[CurStand].CLASS);
		FaceComp[1]->GetComponent<SpriteRender>()->SetSprite(L"Race.png", Pieces[CurStand].RACE1);
		FaceComp[4]->GetComponent<SpriteRender>()->SetSprite(L"Stars.png", 8 + CurStar);

		if (Pieces[CurStand].RACE2 != 0)
		{
			FaceComp[2]->GetComponent<SpriteRender>()->SetSprite(L"Race.png", Pieces[CurStand].RACE2);
		}
		else
		{
...
#pragma region MouseClick
	...
	{
		ESCButton->GetComponent<SpriteRender>()->SetSprite(L"ESC.png", 1);
	...
	{
		ESCButton->GetComponent<SpriteRender>()->SetSprite(L"ESC.png", 0);
	}
	...
	{
		GetOutButton->GetComponent<SpriteRender>()->SetSprite(L"Exit.png", 1);
	...
	{
		GetOutButton->GetComponent<SpriteRender>()->SetSprite(L"Exit.png", 0);
	}
