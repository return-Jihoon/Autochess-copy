...
void LobySceneUpdater::Loading()
{
	...
	Font = Resources::Find<EngineFont>(L"1»∆∂±∫∫¿Ã");
...
//	Resources::Create<Sprite>(L"AlphaPlate.png", L"AlphaPlate.png", 8, 4, 0, 32);

	{
		...
		HPTR<SpriteRender> SR = BCloud1->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
...

	{
		...
		HPTR<SpriteRender> SR = BCloud2->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
		SR->SetSprite(L"LBCloud.png", 0);
...

	{
		...
		HPTR<SpriteRender> SR = BCloud3->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
		SR->SetSprite(L"LBCloud.png", 0);
...

	{
		...
		HPTR<SpriteRender> SR = BPlate->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
...

	{
		...
		HPTR<SpriteRender> SR = UpperBar->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
...

	{
		...
		HPTR<SpriteRender> SR = CLSceneButton->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
...

	{
		...
		HPTR<SpriteRender> SR = OptionButton->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
...

	{
		...
		HPTR<SpriteRender> SR = STSceneButton->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
...
void LobySceneUpdater::SceneUpdate()
{
	...
	{
		OptionButton->GetComponent<SpriteRender>()->SetSprite(L"CCbtn.png", 1);
	}
	else
	{
		OptionButton->GetComponent<SpriteRender>()->SetSprite(L"CCbtn.png", 0);
	}


	if ((MouseInTheBox(CLSceneButton) == true))
	{
		CLSceneButton->GetComponent<SpriteRender>()->SetSprite(L"CCbtn.png", 3);
	...
	{
		CLSceneButton->GetComponent<SpriteRender>()->SetSprite(L"CCbtn.png", 2);
	}
