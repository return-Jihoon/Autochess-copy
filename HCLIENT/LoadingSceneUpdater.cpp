...
void LoadingSceneUpdater::Loading()
{
...

	{
		...
		HPTR<SpriteRender> SR = BGIMG->AddComponent<SpriteRender>(RENDERGROUP::RG_GRID);
...

	{
		...
		LoadingBarSR = LoadingBar->AddComponent<SpriteRender>(RENDERGROUP::RG_GRID);
...

	{
		...
		HPTR<SpriteRender> SR = LoadingCircle->AddComponent<SpriteRender>(RENDERGROUP::RG_GRID);
