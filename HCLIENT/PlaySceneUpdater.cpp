...
#pragma endregion
	...
	HPTR<SpriteRender> chessPlayerSprite = chessPlayer->AddComponent<SpriteRender>(RG_PLAYER);
...
#pragma region FLOWER LOG GRASS BUSH
...

	{
		...
		HPTR<SpriteRender> battleTopFrameSR = battleTopFrame->AddComponent<SpriteRender>(RENDERGROUP::RG_PLAYER);
...
{
		{
			...
			HPTR<SpriteRender> SR = CombineRACE[0]->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
		...
		}
		{
			...
			HPTR<SpriteRender> SR = CombineRACE[1]->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
		...
		}
		{
			...
			HPTR<SpriteRender> SR = CombineRACE[2]->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
		...
		}
		{
			...
			HPTR<SpriteRender> SR = CombineRACE[3]->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
		...
		}
		{
			...
			HPTR<SpriteRender> SR = CombineRACE[4]->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
		...
		}
		{
			...
			HPTR<SpriteRender> SR = CombineCLASS[0]->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
		...
		}
		{
			...
			HPTR<SpriteRender> SR = CombineCLASS[1]->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
		...
		}
		{
			...
			HPTR<SpriteRender> SR = CombineCLASS[2]->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
		...
		}
		{
			...
			HPTR<SpriteRender> SR = CombineCLASS[3]->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
		...
		}
		{
			...
			HPTR<SpriteRender> SR = CombineCLASS[4]->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
		...
		}
		{
			...
			HPTR<SpriteRender> SR = CombineBP->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
	...
	for (int i = 0; i < 10; ++i)
	{
		...
		HPTR<SpriteRender> SR = CombineFIRE[i]->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
...

	{
		...
		HPTR<SpriteRender>  battleTopFrameSR = unitSeller->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
...

	{
		...
		//monster->GetTransform()->SetScale({ 640.0f / GameWindow::Inst()->GetWindowSize().y , 480.0f / GameWindow::Inst()->GetWindowSize().y });
		//monster->GetTransform()->LocalScaleMultiple(GameWindow::Inst()->GetWindowSize().y / 100.0f);
		HPTR<SpriteRender> battleTopFrameSR = battleTopFrame->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
...

	{
		...
		HPTR<SpriteRender> SR = Mouse->AddComponent<SpriteRender>(RENDERGROUP::RG_UI);
...
void PlaySceneUpdater::CombinationPiece()
{
	...
	else
	{
		...
		for (int i = 0; i < 5; ++i)
		{
			...
			{
				CombineRACE[i]->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", L"Race_HF.png");
			}
			else
			{
				CombineRACE[i]->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", L"Race.png");
			}
		}
		...
		for (int i = 0; i < 5; ++i)
		{
			...
			{
				CombineCLASS[i]->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", L"Class_HF.png");
			}
			else
			{
				CombineCLASS[i]->GetComponent<SpriteRender>()->LinkTexture(L"PS_MAPTEX", L"Class.png");
			}
		}
